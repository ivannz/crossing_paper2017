...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\linewidth}
        \includegraphics[width=\linewidth]{images/sample_path.pdf}
    \end{subfigure}\\
    \begin{subfigure}{\linewidth}
        \includegraphics[width=\linewidth]{images/sample_tree.pdf}
    \end{subfigure}
...
place during the $k$-th crossing of grid $2^n\delta$, and $N_n$ be the total number
